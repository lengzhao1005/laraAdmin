...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="{{ url('/admin/permissions') }}" method="post" lay-filter="component-form-group" enctype="multipart/form-data">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="tel" name="name" lay-verify="name" autocomplete="off" placeholder="请输入权限名称" value="{{ old('name') }}" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="url" autocomplete="off" value="{{ old('url') }}" class="layui-input" placeholder="/admin/permission">
                    </div>
                </div>
