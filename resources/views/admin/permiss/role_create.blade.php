...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="{{ url('/admin/roles') }}" method="post" lay-filter="component-form-group" enctype="multipart/form-data">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="tel" name="name" lay-verify="name" autocomplete="off" placeholder="请输入角色名称" value="{{ old('name') }}" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="description" lay-verify="description" placeholder="添加用户的角色" autocomplete="off" value="{{ old('description') }}" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" checked="" value="T" name="status" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
                    </div>
                </div>
                        ...
                        @foreach($permission as $key=>$value)
                            <div class="layui-input-inline" style="padding: 10px; margin-bottom: 10px;background-color: #F5F5F5">
                                ...
                                @foreach($value as $k=>$v)
                                    <span>
                                        <input type="checkbox" lay-skin="primary" lay-filter="oneChoose" value="{{ $v['id'] }}" name="permiss[{{ $v['id'] }}]" title="{{ $v['name'] }}">
                                    </span>
                                @endforeach
                            </div>
                        @endforeach
