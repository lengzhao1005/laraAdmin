            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('admin/users')}}"><i class="fa icon ion-ios-person"></i>用户列表</a></li>
                        <li><a href="#"><i class="fa fa-male"></i>角色列表</a></li>
                        <li><a href="#"><i class="fa icon ion-ios-unlocked"></i>权限列表</a></li>
                    </ul>
                </li>
